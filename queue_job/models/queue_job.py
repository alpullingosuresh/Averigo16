...
#             mail = self.env['mail.mail'].with_user(1).create({
#                 'subject': "error in reconciliation",
#                 'email_from': 'support@averigo.com',
#                 'email_to': 'neethu@cybrosys.in,testdinoworkmail@gmail.com',
#                 'body_html': "error - %s <br/>request" % str(vals),
#             })
#             mail.send()
